...
public class LobbyMenuController : Singleton<LobbyMenuController>
{
    private User sessionUser = null; // The local user, set after login
    ...
    private void Start()
    {
        ...
        OpenAllParents();
        CloseAllMenus();
        activeMenu = GetMenuByType(LobbyMenuType.LOGIN);
